...
00000e33 <wait_for_process>:
SYSCALL(wait_for_process)
     e33:	b8 1d 00 00 00       	mov    $0x1d,%eax
     e38:	cd 40                	int    $0x40
     e3a:	c3                   	ret    

00000e3b <find_next_prime_number>:
SYSCALL(find_next_prime_number)
     e3b:	b8 16 00 00 00       	mov    $0x16,%eax
     e40:	cd 40                	int    $0x40
     e42:	c3                   	ret    

00000e43 <get_call_count>:
SYSCALL(get_call_count)
     e43:	b8 18 00 00 00       	mov    $0x18,%eax
     e48:	cd 40                	int    $0x40
     e4a:	c3                   	ret    

00000e4b <get_most_caller>:
SYSCALL(get_most_caller)
     e4b:	b8 17 00 00 00       	mov    $0x17,%eax
     e50:	cd 40                	int    $0x40
     e52:	c3                   	ret    
