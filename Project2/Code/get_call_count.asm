...
main(int argc, char *argv[])
{
  ...
  if (fork() == 0) {
  15:	e8 31 03 00 00       	call   34b <fork>
  1a:	85 c0                	test   %eax,%eax
  1c:	75 74                	jne    92 <main+0x92>
    printf(1, "child fork count %d\n", get_call_count(SYS_fork));
  1e:	83 ec 0c             	sub    $0xc,%esp
  21:	6a 01                	push   $0x1
  23:	e8 db 03 00 00       	call   403 <get_call_count>
  28:	83 c4 0c             	add    $0xc,%esp
  2b:	50                   	push   %eax
  2c:	68 38 08 00 00       	push   $0x838
  31:	6a 01                	push   $0x1
  33:	e8 98 04 00 00       	call   4d0 <printf>
    printf(1, "child write count %d\n", get_call_count(SYS_write));
  38:	c7 04 24 10 00 00 00 	movl   $0x10,(%esp)
  3f:	e8 bf 03 00 00       	call   403 <get_call_count>
  44:	83 c4 0c             	add    $0xc,%esp
  47:	50                   	push   %eax
  48:	68 4d 08 00 00       	push   $0x84d
  4d:	6a 01                	push   $0x1
  4f:	e8 7c 04 00 00       	call   4d0 <printf>
	printf(1, "child get_call_count count %d\n", get_call_count(SYS_get_call_count));
  54:	c7 04 24 18 00 00 00 	movl   $0x18,(%esp)
  5b:	e8 a3 03 00 00       	call   403 <get_call_count>
  60:	83 c4 0c             	add    $0xc,%esp
  63:	50                   	push   %eax
  64:	68 a0 08 00 00       	push   $0x8a0
  69:	6a 01                	push   $0x1
  ...
  76:	6a 03                	push   $0x3
  78:	e8 86 03 00 00       	call   403 <get_call_count>
  7d:	83 c4 0c             	add    $0xc,%esp
  80:	50                   	push   %eax
  81:	68 90 08 00 00       	push   $0x890
  86:	6a 01                	push   $0x1
  88:	e8 43 04 00 00       	call   4d0 <printf>
  exit();
  8d:	e8 c1 02 00 00       	call   353 <exit>
    wait();
  92:	e8 c4 02 00 00       	call   35b <wait>
    printf(1, "parent fork count %d\n", get_call_count(SYS_fork));
  97:	83 ec 0c             	sub    $0xc,%esp
  9a:	6a 01                	push   $0x1
  9c:	e8 62 03 00 00       	call   403 <get_call_count>
  a1:	83 c4 0c             	add    $0xc,%esp
  a4:	50                   	push   %eax
  a5:	68 63 08 00 00       	push   $0x863
  aa:	6a 01                	push   $0x1
  ac:	e8 1f 04 00 00       	call   4d0 <printf>
    printf(1, "parent write count %d\n", get_call_count(SYS_write));
  b1:	c7 04 24 10 00 00 00 	movl   $0x10,(%esp)
  b8:	e8 46 03 00 00       	call   403 <get_call_count>
  bd:	83 c4 0c             	add    $0xc,%esp
  c0:	50                   	push   %eax
  c1:	68 79 08 00 00       	push   $0x879
  c6:	6a 01                	push   $0x1
  c8:	e8 03 04 00 00       	call   4d0 <printf>
	printf(1, "parent get_call_count count %d\n", get_call_count(SYS_get_call_count));
  cd:	c7 04 24 18 00 00 00 	movl   $0x18,(%esp)
  d4:	e8 2a 03 00 00       	call   403 <get_call_count>
  d9:	83 c4 0c             	add    $0xc,%esp
  dc:	50                   	push   %eax
  dd:	68 c0 08 00 00       	push   $0x8c0
  e2:	6a 01                	push   $0x1
  e4:	e8 e7 03 00 00       	call   4d0 <printf>
...
printf(int fd, const char *fmt, ...)
{
 ...
 654:	eb 1a                	jmp    670 <printf+0x1a0>
          s = "(null)";
 656:	bb e0 08 00 00       	mov    $0x8e0,%ebx
        while(*s != 0){
...
free(void *ap)
{
 ...
 6a5:	a1 90 0b 00 00       	mov    0xb90,%eax
{
 ...
 6c6:	73 10                	jae    6d8 <free+0x38>
{
 ...
 6f1:	5b                   	pop    %ebx
  freep = p;
 6f2:	a3 90 0b 00 00       	mov    %eax,0xb90
}
 6f7:	5e                   	pop    %esi
 6f8:	5f                   	pop    %edi
 6f9:	5d                   	pop    %ebp
 ...
 717:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 71a:	a3 90 0b 00 00       	mov    %eax,0xb90
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 73d:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 740:	8b 3d 90 0b 00 00    	mov    0xb90,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 789:	8b 3d 90 0b 00 00    	mov    0xb90,%edi
 ...
 7b2:	e8 e9 fe ff ff       	call   6a0 <free>
  return freep;
 7b7:	a1 90 0b 00 00       	mov    0xb90,%eax
 ...
 7e4:	89 72 04             	mov    %esi,0x4(%edx)
      freep = prevp;
 7e7:	a3 90 0b 00 00       	mov    %eax,0xb90
}
 ...
 7fe:	66 90                	xchg   %ax,%ax
    base.s.ptr = freep = prevp = &base;
 800:	c7 05 90 0b 00 00 94 	movl   $0xb94,0xb90
 807:	0b 00 00 
    base.s.size = 0;
 80a:	bf 94 0b 00 00       	mov    $0xb94,%edi
    base.s.ptr = freep = prevp = &base;
 80f:	c7 05 94 0b 00 00 94 	movl   $0xb94,0xb94
 816:	0b 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 819:	89 f8                	mov    %edi,%eax
    base.s.size = 0;
 81b:	c7 05 98 0b 00 00 00 	movl   $0x0,0xb98
 822:	00 00 00 
    if(p->s.size >= nunits){
