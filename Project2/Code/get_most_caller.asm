...
int main(void) 
{
  ...
  15:	6a 03                	push   $0x3
  17:	e8 6f 03 00 00       	call   38b <get_most_caller>
  ...
  33:	e8 53 03 00 00       	call   38b <get_most_caller>
  38:	83 c4 0c             	add    $0xc,%esp
  3b:	50                   	push   %eax
  3c:	68 dc 07 00 00       	push   $0x7dc
  41:	6a 01                	push   $0x1
  43:	e8 08 04 00 00       	call   450 <printf>
    printf(1, "pid of the most caller(wrtie): %d\n", get_most_caller(SYS_write));
  48:	c7 04 24 10 00 00 00 	movl   $0x10,(%esp)
  4f:	e8 37 03 00 00       	call   38b <get_most_caller>
  54:	83 c4 0c             	add    $0xc,%esp
  57:	50                   	push   %eax
  58:	68 00 08 00 00       	push   $0x800
  5d:	6a 01                	push   $0x1
...
printf(int fd, const char *fmt, ...)
{
 ...
 5d4:	eb 1a                	jmp    5f0 <printf+0x1a0>
          s = "(null)";
 5d6:	bb 23 08 00 00       	mov    $0x823,%ebx
        while(*s != 0){
