...
_find_next_prime_number_interface:     file format elf32-i386
...
int main(int argc, char *argv[])
{
  ...
  25:	e8 31 03 00 00       	call   35b <find_next_prime_number>
  2a:	83 c4 0c             	add    $0xc,%esp
  2d:	50                   	push   %eax
  2e:	68 98 07 00 00       	push   $0x798
  33:	6a 01                	push   $0x1
  35:	e8 f6 03 00 00       	call   430 <printf>
		asm("movl %0, %%ebx" : : "r"(saved_ebx));
  3a:	89 db                	mov    %ebx,%ebx
		exit();
